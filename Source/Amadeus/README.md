...
|----------------------------------------------|----------------------------------------|
| [Mozart.Encore](../Mozart/)                  | v3.10 (O2Jam Original) / v2.93 GAMANIA |
...
```powershell
.\Amadeus.Encore.exe game:start <username> <password> "C:\Program Files (x86)\e-Games\O2Jam\"
```
...
| Project                                    | Description                                            |
|--------------------------------------------|--------------------------------------------------------|
| [Amadeus](Amadeus/)                        | Executable, controllers, messages, and CLI tasks       |
| [Amadeus.Web](Amadeus.Web/)                | HTTP host that compiles the shared `Encore.Web` source |
| [Amadeus.Server](Amadeus.Server/)          | Build-specific game and protocol logic                 |
| [Amadeus.Data](Amadeus.Data/)              | Build-specific EF Core data model and metadata parsers |
| [Amadeus.Migrations](Amadeus.Migrations/)  | Database migrations organized by provider              |
